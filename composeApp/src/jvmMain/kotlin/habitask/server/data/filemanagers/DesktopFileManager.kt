...
class DesktopFileManager(
    ...
    init {
        SystemFileSystem.createDirectories(paths.defaultServerDirectory)
        if (!SystemFileSystem.exists(paths.recentServers))
            SystemFileSystem.sink(paths.recentServers).close()
    }
