    ...
    Surface(
        ...
        Column(
            ...
            Row(Modifier.weight(1f)) {
                ConsoleWindow(workingDirectory, feedbackConsole, modifier = Modifier.fillMaxHeight().weight(0.5f))
                Spacer(Modifier.width(16.dp))
                ConsoleWindow(workingDirectory, internalConsole, modifier = Modifier.fillMaxHeight().weight(0.5f))
            }

            Spacer(Modifier.height(16.dp))

            CommandBar(commandSent = {
                feedbackConsole.add("> $it")
                internalConsole.add("command sent: \"$it\"")
            })
        }
    }
